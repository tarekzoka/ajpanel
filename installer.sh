...
wget -O /tmp/enigma2-plugin-extensions-ajpanel_v8.8.8_all.deb "https://github.com/tarekzoka/ajpanel/blob/main/enigma2-plugin-extensions-ajpanel_v8.8.8_all.deb?raw=truee"
wait
