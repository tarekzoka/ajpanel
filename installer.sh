...
wget -O /tmp/enigma2-plugin-extensions-ajpanel_v5.4.1_all.deb "https://github.com/tarekzoka/ajpanel/blob/main/enigma2-plugin-extensions-ajpanel_v5.4.1_all.deb?raw=true"
wait
